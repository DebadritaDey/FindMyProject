...
#Defining the about page of the project
    ...
    st.markdown("#### Links")
    annotated_text("Github Repository ",("[link to the project](https://github.com/DebadritaDey/FindMyProject)","  " ,"#fea"), " and ", ("[link to the Dataset](https://docs.google.com/spreadsheets/d/e/2PACX-1vTmIIOHVpRrtU77eVrK-2cU-8MLwMZbuNYVYbBVF6WbS7xnJYvzyZKf99DCJ8hK51wUsm8PI0tBOvND/pubhtml)","  " ,"#fea"), " used in this project.", (""))
    
    st.markdown("#### Connect with me")
    linkedin_button = '<a href="https://www.linkedin.com/in/debadrita-dey-561579250/" target="_blank" style="text-align: center; margin: 0px 10px; padding: 5px 10px; border-radius: 5px; color: white; background-color: #0077B5; text-decoration: none">LinkedIn</a>'
    github_button = '<a href="https://github.com/DebadritaDey" target="_blank" style="text-align: center; margin: 0px 10px; padding: 5px 10px; border-radius: 5px; color: white; background-color: #24292E; text-decoration: none">GitHub</a>' 
